            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <h2 className="text-3xl font-black text-slate-900 tracking-tight">
                        {uid ? 'Edit' : 'Add'} Admission Staff
                    </h2>
                    <p className="text-slate-500 font-medium">
                        {uid ? `Updating Profile: ${formData.first_name}` : 'Register a new Admission Cell member.'}
                    </p>
                </div>
            ...
            {formData.email.includes('@') && (
                <div className="bg-amber-50 border border-amber-200 text-amber-700 px-6 py-3 rounded-xl flex items-center gap-3 animate-in fade-in duration-300">
                    ...
                    <p className="text-sm font-bold">
                        ...
                        Registration Number should not be an email. Use a unique ID (e.g. ADM2024XX)
                    </p>
                </div>
            )}
                        ...
                        <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input required type="text" placeholder="e.g. Admission Officer" className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium text-slate-900"
