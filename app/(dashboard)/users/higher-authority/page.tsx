        ...
        <div className="space-y-6 page-transition pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Manage Top-level Management Staff.</p>
                </div>
                                ...
                                <tr>
                                    <td colSpan={6} className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">No authority record found</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
                                filteredStaff.map((f, idx) => (
                                    <tr key={f.uid} className="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="text-xs font-black text-[#1e3a5f]">{f.designation || 'Higher Authority'}</span>
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                <Link
                                                    href={`/users/higher-authority/add?uid=${f.uid}&project=${project}`}
