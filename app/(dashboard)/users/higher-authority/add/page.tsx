            ...
            {formData.email.includes('@') && (
                <div className="bg-amber-50 border border-amber-200 text-amber-700 px-6 py-3 rounded-xl flex items-center gap-3 animate-in fade-in duration-300">
                    ...
                    <p className="text-sm font-bold">
                        ...
                        Registration Number should not be an email. Use a unique ID (e.g. AUTH2024XX)
                    </p>
                </div>
            )}
                        ...
                        <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input required type="email" placeholder="authority@ctgroup.in" className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium text-slate-900"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input required type="text" placeholder="e.g. Higher Authority" className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium text-slate-900"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input required type="text" placeholder="e.g. AUTH202401"
                                    disabled={!!uid}
