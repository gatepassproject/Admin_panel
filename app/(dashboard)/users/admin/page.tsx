        ...
        <div className="space-y-6 page-transition pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Manage System Administrative Accounts.</p>
                </div>
                            ...
                            {isLoading ? (
                                ...
                                filteredStaff.map((f) => (
                                    <tr key={f.id || f.uid} className="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="text-xs font-black text-[#1e3a5f]">{f.designation || 'System Administrator'}</span>
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                <Link
                                                    href={`/users/admin/add?uid=${f.uid}&project=${project}`}
