        ...
        <div className="max-w-5xl mx-auto space-y-8 page-transition pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <h2 className="text-3xl font-black text-slate-900 tracking-tight">Add Faculty / Authority</h2>
                    <p className="text-slate-500 font-medium">Register a new faculty member or administrative head.</p>
                </div>
            ...
            {isSuccess && (
                <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 px-6 py-4 rounded-2xl flex items-center gap-4 animate-in slide-in-from-top-4 duration-500">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium opacity-90">Faculty account has been created successfully.</p>
                    </div>
                </div>
            )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input required type="email" placeholder="john.doe@ctgroup.in" className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium text-slate-900"
